...
public class SaveImageCallExecutor extends SaveMediaCallExecutor {
    public SaveImageCallExecutor(Plugin plugin, int requestCode) {
    ...
    public JSObject _execute(PluginCall call) throws Exception {
        return saveMedia(call, Environment.DIRECTORY_PICTURES);
    }
}